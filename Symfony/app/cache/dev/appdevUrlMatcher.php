...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // FormFormBundle_homepage
        if ($pathinfo === '/index') {
            return array (  '_controller' => 'Form\\FormBundle\\Controller\\SiteController::indexAction',  '_route' => 'FormFormBundle_homepage',);
        }

        // FormFormBundle_products
        if (0 === strpos($pathinfo, '/products') && preg_match('#^/products/(?<page>[^/]+)$#s', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Form\\FormBundle\\Controller\\SiteController::productsAction',)), array('_route' => 'FormFormBundle_products'));
        }
